...
function updateGraph(layout,statistic,filter)
{
 
    //var inputdata = {"filename": GexfJS.params.graphFile, "layout": layout, "statistic": statistic}
    var qrystr= "filename=" + GexfJS.params.graphFile + "&layout="+ layout + "&statistic=" + statistic + "&filter=" + filter;
    $.ajax({url: "/gephi-on-web-demo/applyfilter?" + qrystr,method: 'POST',       
